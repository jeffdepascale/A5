...
cat ./combine/copyrights.txt ./bin/combine.temp.js > ./bin/A5.js
cat ./combine/copyrights.txt ./bin/combine-min.temp.js > ./bin/A5-min.js
rm ./bin/combine.temp.js
rm ./bin/combine-min.temp.js
gzip -c ./bin/A5-min.js > ./bin/A5-min.js.gz
: -------------------- index close--------------------
echo '<body>\n\t</body>\n</html>' >> ./bin/index.html